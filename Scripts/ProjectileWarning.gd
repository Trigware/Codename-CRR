...
const warning_show_duration = 0.4
...
func _process(delta: float):
	...
	scale = Vector2.ONE * screen_dimen_size * relative_scale * projectile_scale_multiplier / projectile_warning_size
	var scaled_size = projectile_warning_size * scale
	position = screen_size * relative_position - scaled_size * relative_position
